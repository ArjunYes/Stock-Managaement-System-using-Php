...
<body>
	...
	<div class="container1">
        <center><h1 class="centerheader">DELETE STAFF</h1></center>
		<div class="container2">
          ...
          <form  method="POST" >
           ...
           <input class="btn1" type="submit" name="sub1" value="DELETE STAFF ">
...
if(isset($_POST['sub1'])){
	...
	$sql2 = "DELETE FROM staff_details WHERE Staff_id = '$temp'";
	

	if(mysqli_query($conn,$sql2)){
     echo "STAFF DELETED";
     $message = "Staff succesfully deleted";
