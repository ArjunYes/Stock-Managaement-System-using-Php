        ...
        <select class="in1" name="selectbox1" required="">
            <option  value="">Select Item </option>
                ...
                while ($row = mysqli_fetch_assoc($result)){
                    ...
                    $IC = $row['Item_code'];
                ?>
                <option value="<?php echo $IC ?>"><?php echo $IC," - ",$IN ?></option>
                <?php
            }
            ?>
        </select>
        <input class="btn1" type="submit" name="sub1" value="DELETE ITEM ">
...
if(isset($_POST['sub1'])){
    ...
    $sql2 = "DELETE FROM item WHERE Item_code = '$temp'";
    $sql3 = "DELETE FROM office_stock WHERE Item_code = '$temp'";
